# https://launchschool.com/exercise_sets/5e5f2772
# 1
# class Library
...
#   def display_books # solution in the method
#     books.each do |book|
#       book.display_data
#     end
#   end
...
# # community_library.books.each {|book| book.display_data} # solution out of the method
# community_library.display_books # solution in the method

# # error occurs because we are calling Book#display_data on an array object, not a Book object
...
# # error occurs in Songbird#initialize instance method - super keyword is used but all arguments are passed
# # up the method lookup chain. FlightlessBird#initialize only takes two methods and we are passing it three
# # solution is to add two arguments to super
...
# # puts grace.location.longitude
# puts ada.location == grace.location # expected: true
#                                     # actual: false
# # error occurs because we don't have a custom == method that checks if the values for the location instance variable
# # is the same in each class
# # since location is a GeoLocation collaborator object, we need to define the method in the GeoLocation class
...
# # private method was being called on explicit receiver, changed it to protected
...
#   def to_s
#     "#{name}.#{self.class::FORMAT}" #needed namespacing to explain the method lookup path
#   end
# end
...
# finish exercises, do explanations one more time
