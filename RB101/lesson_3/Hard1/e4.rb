...
# that determines if a string is a numeric string between 0 and 255 as required for IP
...
# more or fewer than 4 components to the IP address (e.g. "4.5.5" or "1.2.3.4.5" should
# be invalid)."

# had trouble with this one.. need to revisit