...
DEGREE = "\xC2\xB0"
DEGREE_PER_MINUTE = 60
DEGREE_PER_SECOND = 60


# PEDAC:
# need to use string interpolation "%(degree DEGREE minute ' second ")"
...
#   puts "%(#{deg}#{DEGREE}#{min}'#{sec})"

# end

# couldn't figure out the math needed to get minutes and seconds
